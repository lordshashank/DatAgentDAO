...
// import {BigNumbers, BigNumber} from "../lib/solidity-bignumber/src/BigNumbers.sol";
...
contract DatAgentDAO is Ownable {
    ...
    event DataProvided(address indexed provider, DealRequest deal);
    ...
    function provideDataSet(
        ...
        emit DataProvided(msg.sender, deal);
        return true;
    }
}
